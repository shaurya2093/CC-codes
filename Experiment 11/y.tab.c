...
#line 1142 "y.tab.c"
  ...
  case 7: /* expr: expr '+' NUMBER  */
#line 32 "exp11.y"
                      { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1148 "y.tab.c"
    break;

  case 8: /* expr: expr '-' NUMBER  */
#line 33 "exp11.y"
                      { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1154 "y.tab.c"
    break;

  case 9: /* expr: expr '*' NUMBER  */
#line 34 "exp11.y"
                      { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1160 "y.tab.c"
    break;

  case 10: /* expr: expr '/' NUMBER  */
#line 35 "exp11.y"
                      { if ((yyvsp[0].num) != 0) (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); else { yyerror("Division by zero"); (yyval.num) = 0; } }
#line 1166 "y.tab.c"
    break;

  case 11: /* expr: expr '^' NUMBER  */
#line 36 "exp11.y"
